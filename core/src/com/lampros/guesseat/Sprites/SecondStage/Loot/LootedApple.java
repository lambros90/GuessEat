...
public class LootedApple extends Loot {
    private Sound soundApple;

    public LootedApple(SecondStage screen, float x, float y) {
        super(screen, x, y);
        setRegion(screen.getAtlasRedApple().findRegion("red_apple"), 1, 1, 15, 16);
        setBounds(getX(),getY(),10 / GuessEat.PPM,10 / GuessEat.PPM);
    ...
    public void defineLoot() {
        ...
        fdef.filter.categoryBits = GuessEat.LOOT_BIT;
