...
public class LootedGoldenApple extends Loot {
    private Sound soundApple;

    public LootedGoldenApple(SecondStage screen, float x, float y) {
        super(screen, x, y);
        setRegion(screen.getAtlasGoldenApple().findRegion("golden_apple"), 1, 1, 16, 16);
