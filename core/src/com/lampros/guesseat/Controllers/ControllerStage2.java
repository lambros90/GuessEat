...
public class ControllerStage2 implements Disposable {
    ...
    public static void setFireballPressed(boolean fireballPressed) {
        ControllerStage2.fireballPressed = fireballPressed;
    }

    public static void setUpPressed(boolean upPressed) {
        ControllerStage2.upPressed = upPressed;
    }
    ...
    public void dispose() {
        stage.dispose();
        Gdx.app.log("ControllerStage2","Got disposed");
    }
